...
Welcome to ``recruit`` contributor's guide.
...
If you experience bugs or general issues with ``recruit``, please have a look
...
You can help improve ``recruit`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``recruit`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``recruit``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n recruit python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/recruit.git
    cd recruit
...
#. Install |pre-commit|_::
   ...
   ``recruit`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/recruit
.. _issue tracker: https://github.com/<USERNAME>/recruit/issues
.. <-- end -->
